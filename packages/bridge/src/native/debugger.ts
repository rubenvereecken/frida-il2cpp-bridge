 ...
 */
export const getNativeDebuggerSetAgentOptions = memoize(() =>
 ...
 */
export const getNativeIsDebuggerAttached = memoize(() =>
 ...
 */
export const getNativeRegisterDebuggerAgentTransport = memoize(() =>
