 ...
 */
export const nativeGcHandleNew = slow(() =>
 ...
 */
export const nativeGcHandleNewWeakRef = slow(() =>
 ...
 */
export const nativeGcHandleGetTarget = slow(() =>
 ...
 */
export const nativeGcHandleFree = slow(() => lookup('il2cpp_gchandle_free', 'void', ['uint32']));
 ...
 */
export const nativeGcHandleForEachGetTarget = slow(() =>
