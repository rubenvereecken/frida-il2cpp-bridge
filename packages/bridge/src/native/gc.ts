 ...
 */
export const getNativeGcCollect = memoize(() => lookup('il2cpp_gc_collect', 'void', ['int']));

/**
 * Performs a small incremental garbage collection.
 * @returns int32_t - Result of the collection
 */
export const getNativeGcCollectALittle = memoize(() =>
    lookup('il2cpp_gc_collect_a_little', 'int32', [])
);

/**
 * Starts an incremental garbage collection.
 */
export const getNativeGcStartIncrementalCollection = memoize(() =>
 ...
 */
export const getNativeGcDisable = memoize(() => lookup('il2cpp_gc_disable', 'void', []));

/**
 * Enables garbage collection.
 */
export const getNativeGcEnable = memoize(() => lookup('il2cpp_gc_enable', 'void', []));

/**
 * Determines whether garbage collection is disabled.
 * @returns bool - True if GC is disabled
 */
export const getNativeGcIsDisabled = memoize(() => lookup('il2cpp_gc_is_disabled', 'bool', []));

/**
 * Sets the garbage collection mode.
 * @param mode Il2CppGCMode - The GC mode to set
 */
export const getNativeGcSetMode = memoize(() => lookup('il2cpp_gc_set_mode', 'void', ['int']));

/**
 * Gets the maximum time slice for incremental GC in nanoseconds.
 * @returns int64_t - The maximum time slice in nanoseconds
 */
export const getNativeGcGetMaxTimeSlice = memoize(() =>
 ...
 */
export const getNativeGcSetMaxTimeSlice = memoize(() =>
 ...
 */
export const getNativeGcIsIncremental = memoize(() => lookup('il2cpp_gc_is_incremental', 'bool', []));

/**
 * Gets the amount of memory currently used by the GC heap.
 * @returns int64_t - The used heap size in bytes
 */
export const getNativeGcGetUsedSize = memoize(() => lookup('il2cpp_gc_get_used_size', 'int64', []));

/**
 * Gets the total size of the GC heap.
 * @returns int64_t - The heap size in bytes
 */
export const getNativeGcGetHeapSize = memoize(() => lookup('il2cpp_gc_get_heap_size', 'int64', []));
 ...
 */
export const getNativeGcWbarrierSetField = memoize(() =>
 ...
 */
export const getNativeGcHasStrictWbarriers = memoize(() =>
 ...
 */
export const getNativeGcSetExternalAllocationTracker = memoize(() =>
 ...
 */
export const getNativeGcSetExternalWbarrierTracker = memoize(() =>
 ...
 */
export const getNativeGcForEachHeap = memoize(() =>
 ...
 */
export const getNativeGcStopWorld = memoize(() => lookup('il2cpp_stop_gc_world', 'void', []));

/**
 * Starts the garbage collector world (resumes all managed threads).
 */
export const getNativeGcStartWorld = memoize(() => lookup('il2cpp_start_gc_world', 'void', []));
