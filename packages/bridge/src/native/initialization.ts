 ...
 */
export const nativeInitialize = slow(() => lookup('il2cpp_init', 'int', ['pointer']));
 ...
 * @returns int - Non-zero on success, zero on failure
 */
export const nativeInitializeUtf16 = slow(() => lookup('il2cpp_init_utf16', 'int', ['pointer']));

/**
 * Shuts down the IL2CPP runtime.
 */
export const nativeShutdown = slow(() => lookup('il2cpp_shutdown', 'void', []));

/**
 * Sets the configuration directory for IL2CPP.
 * @param config_path const char* - Path to the configuration directory
 */
export const nativeSetConfigDir = slow(() => lookup('il2cpp_set_config_dir', 'void', ['pointer']));

/**
 * Sets the data directory for IL2CPP.
 * @param data_path const char* - Path to the data directory
 */
export const nativeSetDataDir = slow(() => lookup('il2cpp_set_data_dir', 'void', ['pointer']));

/**
 * Sets the temporary directory for IL2CPP.
 * @param temp_path const char* - Path to the temporary directory
 */
export const nativeSetTempDir = slow(() => lookup('il2cpp_set_temp_dir', 'void', ['pointer']));
 ...
 */
export const nativeSetCommandlineArguments = slow(() =>
 ...
 */
export const nativeSetCommandlineArgumentsUtf16 = slow(() =>
 ...
 */
export const nativeSetConfigUtf16 = slow(() =>
 ...
 */
export const nativeSetConfig = slow(() => lookup('il2cpp_set_config', 'void', ['pointer']));
 ...
 */
export const nativeSetMemoryCallbacks = slow(() =>
 ...
 */
export const nativeAddInternalCall = slow(() =>
 ...
 */
export const nativeResolveInternalCall = slow(() =>
 ...
 */
export const nativeGetCorlib = slow(() => lookup('il2cpp_get_corlib', 'pointer', []));
