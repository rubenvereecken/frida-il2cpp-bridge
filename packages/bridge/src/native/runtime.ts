 ...
 */
export const nativeObjectHeaderSize = slow(() => lookup('il2cpp_object_header_size', 'uint32', []));

/**
 * Gets the size of the array object header.
 * @returns uint32_t - The array object header size in bytes
 */
export const nativeArrayObjectHeaderSize = slow(() =>
 ...
 */
export const nativeOffsetOfArrayLengthInArrayObjectHeader = slow(() =>
 ...
 */
export const nativeOffsetOfArrayBoundsInArrayObjectHeader = slow(() =>
 ...
 */
export const nativeAllocationGranularity = slow(() =>
 ...
 */
export const nativeRuntimeInvoke = slow(() =>
 ...
 * @returns Il2CppObject* - The return value of the method
 */
export const nativeRuntimeInvokeConvertArgs = slow(() =>
 ...
 */
export const nativeRuntimeUnhandledExceptionPolicySet = slow(() =>
