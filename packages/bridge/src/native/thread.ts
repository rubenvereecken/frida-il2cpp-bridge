 ...
 */
export const nativeThreadGetCurrent = slow(() => lookup('il2cpp_thread_current', 'pointer', []));
 ...
 */
export const nativeThreadAttach = slow(() =>
 ...
 */
export const nativeThreadDetach = slow(() => lookup('il2cpp_thread_detach', 'void', ['pointer']));
 ...
 */
export const nativeThreadGetAttachedThreads = slow(() =>
 ...
 */
export const nativeThreadIsVm = slow(() => lookup('il2cpp_is_vm_thread', 'bool', ['pointer']));
